...
function send(params) {
  ...
  return function (state) {
    var _expandReferences = (0, _languageCommon.expandReferences)(params)(state),
        ...
        message_uuid = _expandReferences.message_uuid;

    var _state$configuration = state.configuration,
        system_id = _state$configuration.system_id,
        password = _state$configuration.password,
        clientHost = _state$configuration.clientHost,
        inbox_uuid = _state$configuration.inbox_uuid;


    var url = clientHost + '/smpp/' + inbox_uuid + '/send';

    var body = { recipient: recipient, sender: sender, text: text, message_uuid: message_uuid, inbox_uuid: inbox_uuid };
